...
<body>
    ...
    <!-- SCIPTS -->
	<script src="{{('public/assets/frontend/js/jquery-3.1.1.min.js')}}"></script>

	<script src="{{('public/assets/frontend/js/tether.min.js')}}"></script>

	<script src="{{('public/assets/frontend/js/bootstrap.js')}}"></script>
